...
//METODOS DE INSERÇÃO\\
//metodo inserir: public void inseririnicio(Presidente presidente)
// --> insere na primeira posicao da LISTA e remaneja os demais


//metodo inserir em posição: public void inserir(Presidente presidente, int posicao)
// --> insere um registro na posição p da Lista onde p<N e N e o 
//numero de registros cadastrados, remanejando os outros logo em seguida

//metodo inserir fim: public void inserirFim(Presidente presidente)
// --> insere um registro na ultima posição



//METODOS DE REMOÇÃO\\
//metodo removerInicio: Presidente removerInicio()
// --> remove o primeiro registro da lista e retorna seu valor


//metodo remover em posição: Presidente remover(int posicao)
// --> remove aquela posicao e remaneja os demais 
//metodo remover fim: Presidente removerFim()
// --> remove a ultima posição e retorna a posicao apagada
...
public class Classe{
	...
	public static void main(String[] args)throws Exception{
		...
		Lista listaDePresidentes = new Lista(50);
		String save[] = new String[200];
		entrada = MyIO.readLine();
		int x=0,i=0,contador=0;

		//while de entrada de valores iniciais ate a palavra FIM, constoem a primeira lista
		while(!entrada.equals("FIM ")){
			Presidente pres = new Presidente();
			pres.ler(entrada);
			listaDePresidentes.inserirFim(pres);
			entrada = MyIO.readLine();
			x++;
		}

		//while que recebe entrada e pesquisa por esses nomes no array de presidentes
		entrada = MyIO.readLine();
		while(!entrada.equals("FIM")){
			save[i]=listaDePresidentes.pesquisar(entrada); //salva sim ou nao no array de Strings
			entrada = MyIO.readLine();
			i++;	
			
		}

		//while para printar os resultados no formato ISO
		//MyIO.setCharset("ISO-8859-1");
		int o=0;
		while(o<i){
			MyIO.println(save[o]);
		...
		long resp = System.currentTimeMillis()-tempoInicio;
		contador = listaDePresidentes.getContador();
